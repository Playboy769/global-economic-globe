...
Private Sub DrawDisclaimer(ws As Worksheet, startRow As Long)
    ...
    ws.Range(ws.cells(r, 1), ws.cells(r, 16)).Merge
    On Error GoTo 0
    ws.cells(r, 1).Value = "Expected to DO 2 => TWII = Some tickers in hand can be replace => MLCC:2327°ê¥¨/3026¥Ý¦ù°ó/3090/6173 , ProbeCard: 2360/6223/6515 , ¥ý¶i«Ê¸Ë¡G3711/3481/6239 , "
    ws.cells(r, 1).Font.Color = RGB(255, 255, 255)
    ws.cells(r, 1).HorizontalAlignment = xlLeft
    ws.cells(r, 1).Font.Bold = True
    ...
    ws.Range(ws.cells(r, 1), ws.cells(r, 16)).Merge
    On Error GoTo 0
    ws.cells(r, 1).Value = "Note => 3026 ³B¸m¨ì 0702 , 7828 ³B¸m¨ì 0702"
    ws.cells(r, 1).Font.Color = RGB(255, 255, 255)
    ws.cells(r, 1).HorizontalAlignment = xlLeft
    ws.cells(r, 1).Font.Bold = True
End Sub
